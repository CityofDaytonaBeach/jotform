...
|-------------|-------------|
| <a href="https://cityofdaytonabeach.github.io/jotform-widgets/search-users-widget.html" target="_blank">search-users-widget.html</a> | Fetches user data from a Supabase Edge Function connected to the Microsoft Graph API. Allows searching by last name, first name (`Lastname, Firstname` format) and auto-fills Jotform fields. |
